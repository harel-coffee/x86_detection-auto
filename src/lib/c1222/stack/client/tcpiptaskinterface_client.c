...
int StartSendToServer(Unsigned8* buffer, Unsigned16 length)
{
...
int SendToServer(Unsigned8* buffer, Unsigned16 length)
{
...
Boolean HandleMessageFromServer(C1222Stack* pStack)
{
    ...
    {        
        ...
        {
			printf("CM: In handle received message from server. Passed ACSE Message valid format check\n");
        ...
        else
        {
			...
			printf("Received a message but it is not of a proper format\n");

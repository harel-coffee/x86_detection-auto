# I removed c1222server.c and .obj from these labels. There is some compilation error in that file. Have to figure it out later.
...
SRCFILES =  acsemsg.c c1222al.c c1222al_commmodule.c c1222al_device.c c1222al_messagereceiver.c \
			...
			c1222encrypt.c c1222localPortRouter.c c1222misc.c\
			 c1222server.c c1222stack.c c1222test.c c1222tl.c cbitarray.c epsem.c simulatehost.c \
...
OBJ_FILES = acsemsg.obj c1222al.obj c1222al_commmodule.obj c1222al_device.obj c1222al_messagereceiver.obj \
			...
			c1222encrypt.obj c1222localPortRouter.obj c1222misc.obj  \
			 c1222server.obj c1222stack.obj c1222test.obj c1222tl.obj cbitarray.obj epsem.obj simulatehost.obj \
			tcpiptaskinterface.obj teststacklogroutines.obj testtableserver.obj network.obj tcpiptask.obj \
			uart.obj
		

CFLAGS = -DWANT_TCPIP -DAVOID_PORTAB_H -DC1222_INCLUDE_COMMMODULE -DC1222_INCLUDE_DEVICE \
         -DC1222_INCLUDE_RELAY -DC1222TOOL -DAVOID_SLB_H -DC1222_TABLESERVER_BIGENDIAN -c -nOUT 
		 
#DEL = DELETE


$(OBJ_FILES) : $(SRCFILES) $(HDR_FILES)
	$(CC) $(CFLAGS) $(SRCFILES) 
